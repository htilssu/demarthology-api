...
from app.use_cases.question_uc import CreateQuestionUC, GetQuestionDetailUC, ListPendingQuestionsUC, ListQuestionsUC
...
async def create_question(
    ...
    question_data = QuestionCreate(title=title, content=content, symptom_ids=parsed_symptom_ids)
...
async def get_question_detail(question_id: str, uc: UseCase = Depends(GetQuestionDetailUC)):
