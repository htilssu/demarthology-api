...
class TestRegisterUC(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.register_uc = RegisterUC(user_repository=self.mock_user_repository)
    ...
    async def test_successful_registration(self):
        ...
        # Mock the User creation and creation method
        ...
        with unittest.mock.patch('app.use_cases.register_uc.User', return_value=mock_user):
            ...
            self.mock_user_repository.find_by_email.assert_called_once_with("newuser@example.com")
