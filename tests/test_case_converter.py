...
from app.utils.case_converter import camel_to_snake, convert_dict_keys_to_camel, convert_dict_keys_to_snake, snake_to_camel
...
class TestCaseConverter(unittest.TestCase):
    ...
    def test_convert_dict_keys_to_snake_simple(self):
        ...
        input_dict = {"firstName": "John", "lastName": "Doe", "rememberMe": True}
        expected = {"first_name": "John", "last_name": "Doe", "remember_me": True}
    ...
    def test_convert_dict_keys_to_snake_nested(self):
        ...
        input_dict = {
            "userInfo": {
                "firstName": "John",
                "lastName": "Doe",
                "contactInfo": {"emailAddress": "john@example.com", "phoneNumber": "123-456-7890"},
            },
            "rememberMe": True,
        }
        expected = {
            "user_info": {
                "first_name": "John",
                "last_name": "Doe",
                "contact_info": {"email_address": "john@example.com", "phone_number": "123-456-7890"},
            },
            "remember_me": True,
        }
        result = convert_dict_keys_to_snake(input_dict)
    ...
    def test_convert_dict_keys_to_snake_with_lists(self):
        ...
        input_dict = {
            "userList": [{"firstName": "John", "lastName": "Doe"}, {"firstName": "Jane", "lastName": "Smith"}],
            "totalCount": 2,
        }
        expected = {
            "user_list": [{"first_name": "John", "last_name": "Doe"}, {"first_name": "Jane", "last_name": "Smith"}],
            "total_count": 2,
        }
        result = convert_dict_keys_to_snake(input_dict)
        self.assertEqual(result, expected)
    ...
    def test_convert_dict_keys_to_camel_simple(self):
        ...
        input_dict = {"first_name": "John", "last_name": "Doe", "remember_me": True}
        expected = {"firstName": "John", "lastName": "Doe", "rememberMe": True}
    ...
    def test_round_trip_conversion(self):
        ...
        original = {"firstName": "John", "lastName": "Doe", "userInfo": {"emailAddress": "john@example.com", "isActive": True}}
