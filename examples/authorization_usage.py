...
async def admin_only_endpoint(
    ...
    await require_permission(current_user, admin_permission)
...
async def moderator_or_admin_endpoint(
    ...
    await require_any_permission(current_user, permissions)
...
async def get_user_profile(
    ...
    await require_permission(current_user, permission, target_resource)
...
async def user_dashboard(
    ...
    await require_permission(current_user, user_permission)
...
async def conditional_access_endpoint(
    ...
    admin_permission = AdminPermission()
    is_admin = await check_permission(current_user, admin_permission)
...
async def custom_permission_endpoint(
    ...
    await require_permission(current_user, owner_permission)
